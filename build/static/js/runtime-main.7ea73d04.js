!(function (e) {
  function t(t) {
    for (var n, o, f = t[0], d = t[1], u = t[2], i = 0, s = []; i < f.length; i++) (o = f[i]), Object.prototype.hasOwnProperty.call(a, o) && a[o] && s.push(a[o][0]), (a[o] = 0);
        ...
        t.push(
          (o[e] = new Promise(function (t, r) {
            ...
            for (d = 0; d < i.length; d++) {
              var l;
              if ((u = (l = i[d]).getAttribute("data-href")) === n || u === a) return t();
            }
  ...
  var d = (this.webpackJsonpdriff = this.webpackJsonpdriff || []),
    u = d.push.bind(d);
  (d.push = t), (d = d.slice());
