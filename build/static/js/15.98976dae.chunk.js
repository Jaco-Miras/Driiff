            ...
            function (t, e, n) {
              ...
              var r = {
                ...
                easeInElastic: function (t, e, n, r) {
                  ...
                  return (
                    ...
                    0 === t
                      ...
                      : 1 == (t /= r)
                      ? e + c
                      : ((o = 0) || (o = 0.3 * r), (i = c) < Math.abs(c) ? ((i = c), (a = o / 4)) : (a = (o / (2 * Math.PI)) * Math.asin(c / i)), -i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t * r - a) * (2 * Math.PI)) / o) + e)
                  );
                },
                easeOutElastic: function (t, e, n, r) {
                  ...
                  return (
                    ...
                    0 === t
                      ...
                      : 1 == (t /= r)
                      ? e + c
                      : ((o = 0) || (o = 0.3 * r), (i = c) < Math.abs(c) ? ((i = c), (a = o / 4)) : (a = (o / (2 * Math.PI)) * Math.asin(c / i)), i * Math.pow(2, -10 * t) * Math.sin(((t * r - a) * (2 * Math.PI)) / o) + c + e)
                  );
                },
                easeInOutElastic: function (t, e, n, r) {
                  ...
                  return (
                    ...
                    0 === t
                      ...
                      ? e + c
                      : ((o = 0) || (o = r * (0.3 * 1.5)),
                        (i = c) < Math.abs(c) ? ((i = c), (a = o / 4)) : (a = (o / (2 * Math.PI)) * Math.asin(c / i)),
                        t < 1 ? i * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t * r - a) * (2 * Math.PI)) / o) * -0.5 + e : i * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t * r - a) * (2 * Math.PI)) / o) * 0.5 + c + e)
                  );
                },
                ...
                easeInOutBounce: function (t, e, n, i) {
                  var o = n - e;
                  return t < i / 2 ? 0.5 * r.easeInBounce(2 * t, 0, o, i) + e : 0.5 * r.easeOutBounce(2 * t - i, 0, o, i) + 0.5 * o + e;
                },
              };
              t.exports = r;
            },
            ...
            function (t, e, n) {
              ...
              var l = (function () {
                function t(e, n, r, o) {
                  !(function (t, e) {
                    ...
                    h(this, "shape", void 0),
                    h(this, "angle", void 0),
                    h(this, "angularSpin", void 0),
                    h(this, "color", void 0),
                    h(this, "rotateY", void 0),
                    h(this, "rotationDirection", void 0),
                    h(this, "getOptions", void 0),
                    (this.getOptions = n);
                  var a = this.getOptions(),
                    c = a.colors,
                    s = a.initialVelocityX,
                  ...
                  (this.context = e),
                    ...
                    (this.h = u(5, 20)),
                    (this.radius = u(5, 10)),
                    (this.vx = "number" == typeof s ? u(-s, s) : u(s.min, s.max)),
                    (this.vy = "number" == typeof f ? u(-f, 0) : u(f.min, f.max)),
                    ...
                    (this.rotateY = u(0, 1)),
                    (this.rotationDirection = u(0, 1) ? i.Positive : i.Negative);
                }
                var e, n;
                return (
                  (e = t),
                  (n = [
                    {
                      ...
                      value: function () {
                        ...
                        (this.x += this.vx),
                          ...
                          (this.vx *= o),
                          (this.vy *= o),
                          this.rotateY >= 1 && this.rotationDirection === i.Positive ? (this.rotationDirection = i.Negative) : this.rotateY <= -1 && this.rotationDirection === i.Negative && (this.rotationDirection = i.Positive);
                        var s = 0.1 * this.rotationDirection;
                        if (
                          ((this.rotateY += s),
              ...
              var v = function t(e, n) {
                ...
                !(function (t, e) {
                  ...
                  p(this, "removeParticleAt", function (t) {
                  ...
                  p(this, "animate", function () {
                    ...
                    return (
                      u && ((e.font = "12px sans-serif"), (e.fillStyle = "#333"), (e.textAlign = "right"), e.fillText("Particles: ".concat(l), t.width - 10, t.height - 20)),
                  ...
                  function t(e, n) {
                    ...
                    !(function (t, e) {
                      ...
                      g(this, "setOptionsWithDefaults", function (t) {
                        var e = { confettiSource: { x: 0, y: 0, w: r.canvas.width, h: 0 } };
                      ...
                      g(this, "update", function () {
                        var t = r.options,
                          ...
                          i = r.canvas,
                          o = r.context;
                        e && ((o.fillStyle = "white"), o.clearRect(0, 0, i.width, i.height)),
                          r.generator.animate() ? (r.rafId = requestAnimationFrame(r.update)) : (n && "function" == typeof n && r.generator.particlesGenerated > 0 && n.call(r, r), (r._options.run = !1));
                      }),
                    ...
                    (n = [
                      {
                        ...
                        set: function (t) {
                          ...
                          this.setOptionsWithDefaults(t),
                            this.generator && (Object.assign(this.generator, this.options.confettiSource), "boolean" == typeof t.recycle && t.recycle && !1 === n && (this.generator.lastNumberOfPieces = this.generator.particles.length)),
              ...
              function E(t, e) {
                return !e || ("object" !== m(e) && "function" != typeof e) ? _(t) : e;
              }
              function _(t) {
              ...
              var R = a.a.createRef(),
                F = (function (t) {
                  ...
                  function i(t) {
                    ...
                    return A(_((e = r.call.apply(r, [this, t].concat(o)))), "canvas", a.a.createRef()), A(_(e), "confetti", void 0), (e.canvas = t.canvasRef || R), e;
                  }
                  return (
                    (e = i),
                    (n = [
                      ...
                      },
                      {
                        ...
                        value: function () {
                          var t = (function (t, e) {
                            ...
                            e = t[0],
                            n = t[1],
                            r = j({ zIndex: 2, position: "absolute", pointerEvents: "none", top: 0, left: 0, bottom: 0, right: 0 }, n.style);
                          return a.a.createElement("canvas", x({ width: e.width, height: e.height, ref: this.canvas }, n, { style: r }));
                        },
                      },
                    ]) && C(e.prototype, n),
                    i
              ...
              A(F, "defaultProps", j({}, O)), A(F, "displayName", "ReactConfetti");
              var B = a.a.forwardRef(function (t, e) {
                return a.a.createElement(F, x({ canvasRef: e }, t));
              });
              e.default = B;
            },
          ]).default));
