...
const useWorkspaceFileActions = () => {
    ...
    const fetchPrimary = useCallback((
        ...
        dispatch(
            getWorkspacePrimaryFiles(payload, callback),
        );
    }, [dispatch]);
    ...
    const fetchRecentlyEdited = useCallback((
        ...
        dispatch(
            getWorkspaceRecentlyEditedFiles(payload, callback),
        );
    }, [dispatch]);
    ...
    const fetchImportant = useCallback((
        ...
        dispatch(
            getWorkspaceFavoriteFiles(payload, callback),
        );
    }, [dispatch]);
    ...
    const fetchRemoved = useCallback((
        ...
        dispatch(
            getWorkspaceTrashFiles(payload, callback),
        );
    }, [dispatch]);
    ...
    const fetchPopular = useCallback((
        ...
        dispatch(
            getWorkspacePopularFiles(payload, callback),
        );
    }, [dispatch]);
    ...
    const fetchStats = useCallback((
        ...
        dispatch(
            getWorkspaceFilesDetail(payload, callback),
        );
    }, [dispatch]);
    ...
    const create = useCallback((
        ...
        dispatch(
            uploadWorkspaceFile(payload, callback),
        );
    }, [dispatch]);
    ...
    const remove = useCallback((
        ...
        dispatch(
            deleteWorkspaceFile(payload, callback),
        );
    }, [dispatch]);
    ...
    const restore = useCallback((
        ...
        dispatch(
            restoreWorkspaceFile(payload, callback),
        );
    }, [dispatch]);
