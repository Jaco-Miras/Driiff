...
const OriginalHtmlContainer = styled.div`cursor:pointer; &:hover > div { transition: opacity 2s ease-out; opacity: 1;height: auto;}`;

const OriginalHtml = styled.div`font-size:small;    padding-left: .5em;
border-left: gray 2px solid; transition: opacity 2s ease-in;opacity: 0; height: 0; overflow: hidden;`;
