...
const useChatReply = ({ reply, dictionary, isAuthor, user, recipients, selectedChannel, users, translate, language, _t }) => {
  const parseSystemMessage = useCallback((message) => {
    let newBody = "";
    if (message.startsWith("<div>I started a Google meet: <a href=\"https://meet.google.com/lookup/")) {
      ...
      newBody = _t(
        "CHAT.MEET_MESSAGE",
        "<div>I started a Google meet: <a href=\"https://meet.google.com/lookup/::link::\" rel=\"noopener noreferrer\" target=\"_blank\"><strong>Click here to join</strong></a></div><br/><div><i>Notice this meeting only works if you and the participant are using the same Google WorkSpace domain. If you both use a different domain, share the Google link generated by Google.</i></div>",
