...
const useHuddle = (props) => {
  ...
  return {
    ...
    showQuestions: huddle !== undefined && huddle.questions.find((q) => q.answer === null) !== undefined && !answeredChannels.some((id) => selectedChannel && selectedChannel.id === id) && pastStartTime,
