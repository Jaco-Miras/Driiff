...
const Icon = forwardRef((props, ref) => {
  ...
  return <Wrapper ref={ref} alt={`${type} icon`} className={`icon-${type} ${className}`} src={getIconImageSource(type)} data-event="touchstart focus mouseover" data-event-off="mouseout" data-tip={dataTip} {...rest} />;
});
