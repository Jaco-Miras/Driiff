...
const ImageTextLink = forwardRef((props, ref) => {
    ...
    const {
        className = "", rotate = "", iconPosition = "left", children, href, icon, clickHandler, onClick,
        iconLeft, iconRight, iconLeftRotate, iconRightRotate, iconLeftOnClick, iconRightOnClick, iconRightDataSet,
        iconLeftDataSet, dataSet, target = null, dataTip = "", style = null,
    } = props;
...
ImageTextLink.propTypes = {
    ...
    iconLeftDataSet: oneOfType([
        number,
        string,
        object,
    ]),
    iconRightDataSet: oneOfType([
        number,
        string,
        object,
    ]),
