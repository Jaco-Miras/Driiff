            ...
            <g transform="translate(-358 -223)">
              <g transform="translate(358 414)" opacity="0.346">
                <path
                  ...
                  transform="translate(278) rotate(180)" fill="#f2f2f2" fill-rule="evenodd"/>
                <path
              ...
              <g transform="translate(387 223)">
                <g transform="translate(15)">
                  ...
                  <path d="M8,0H316a8,8,0,0,1,8,8V22H0V8A8,8,0,0,1,8,0Z" fill="#c5cfd6" fill-rule="evenodd"/>
                ...
                <g transform="translate(425 92) rotate(180)">
                  <g transform="translate(425 -0.798) rotate(-180)">
                    ...
                    <g transform="translate(3.93 77.259) rotate(-8)">
                      ...
                      <path
                        ...
                        transform="translate(4.09 -10.945) rotate(5)" fill="#cca8d2" fill-rule="evenodd"/>
                      <path
                      ...
                      <path d="M76.719,34.066q-1.928,29.479,2.268,44.993H68.85a241.428,241.428,0,0,1,7.785-44.7Z"
                            fill="rgba(0,0,0,0.1)" fill-rule="evenodd"/>
                    </g>
                  </g>
                  ...
                  <g transform="translate(0 -137.985)">
                    ...
                    <path d="M92.3,0,55.56-87.842,19.451-162.106H27.97L121.178,0Z" fill="#b28b67" fill-rule="evenodd"/>
                  ...
                  <g transform="translate(24.357 -53.066) rotate(-7)">
                    ...
                    <path
                      ...
                      transform="translate(4.06 10.845) rotate(-5)" fill="#571563" fill-rule="evenodd"/>
                    <path
                ...
                <g transform="translate(124.465 120.816) rotate(-14)">
                  <path d="M50.828,54.607l-.007.016s.007-.025.007-.016" fill="#c5cfd6" fill-rule="evenodd"/>
                  ...
                  <path d="M50.858,54.53c-.007.02-.016.039-.024.059l.012-.028c-.1.26-.038.091.012-.031" fill="#c5cfd6"
                        fill-rule="evenodd"/>
                  <path d="M50.836,54.59l-.012.028c-.029.056.012-.028.012-.028" fill="#c5cfd6" fill-rule="evenodd"/>
                  <path d="M50.825,54.614Z" fill="#c5cfd6" fill-rule="evenodd"/>
                  <path d="M50.824,54.615v0" fill="#c5cfd6" fill-rule="evenodd"/>
                  <path d="M50.819,54.622c-.006.012.028-.046,0,0" fill="#c5cfd6" fill-rule="evenodd"/>
                  <path d="M50.824,54.615l0,0,0,0" fill="#c5cfd6" fill-rule="evenodd"/>
                  <rect width="100" height="66" rx="4" transform="translate(0.575 0.818)" fill="#571563"/>
                  <g transform="translate(9.058 20.093)">
                    <path d="M29.312,0,.471,47H58.152Z" fill="rgba(0,0,0,0.2)" fill-rule="evenodd"/>
                    <path d="M59.047,12.589,33.551,47H84.544Z" fill="rgba(0,0,0,0.2)" fill-rule="evenodd"/>
                  </g>
              ...
              <g transform="translate(390 366)">
                ...
                <g transform="translate(-15.824 -15.81)">
                  ...
                  <g transform="translate(0 184.691)">
                    ...
                    <path d="M128.7,0,77.471,122.466,27.122,226H39L168.967,0Z" fill="#b28b67" fill-rule="evenodd"/>
                  ...
                  <g transform="translate(21.78 80.988)">
                    ...
                    <path
                      ...
                      transform="translate(5.687 -15.1) rotate(5)" fill="#571563" fill-rule="evenodd"/>
                    <path
            ...
            <g transform="translate(-328 -277)">
              <g transform="translate(328 280)" opacity="0.346">
                <path
                  ...
                  transform="translate(500) rotate(180)" fill="#f2f2f2" fill-rule="evenodd"/>
                <path
              ...
              <g transform="translate(556 277)">
                <path d="M48.007,51.986c0,.01-.008.02-.014.032.006-.01.014-.05.014-.032" fill="#c5cfd6"
                      fill-rule="evenodd"/>
                <path d="M48,52a.087.087,0,0,0,0,.01c0-.01.018-.04,0-.01" fill="#c5cfd6" fill-rule="evenodd"/>
                <path d="M48.067,51.832c-.014.04-.032.078-.048.118.008-.02.016-.036.024-.056-.208.52-.076.182.024-.062"
                      fill="#c5cfd6" fill-rule="evenodd"/>
                <path d="M48.022,51.953,48,52.009c-.058.112.024-.056.024-.056" fill="#c5cfd6" fill-rule="evenodd"/>
                <path d="M48,52h0v0Z" fill="#c5cfd6" fill-rule="evenodd"/>
                <path d="M48,52s0,0,0,0,0,0,0,0" fill="#c5cfd6" fill-rule="evenodd"/>
                <path d="M47.99,52.016c-.012.024.056-.092,0,0" fill="#c5cfd6" fill-rule="evenodd"/>
                <path d="M48,52l0,0s0,0,0,0" fill="#c5cfd6" fill-rule="evenodd"/>
                <rect width="95" height="63" rx="4" fill="#dde3e9"/>
                <g transform="translate(8 18)">
                  <path d="M28,0,0,45H56Z" fill="#cca8d2" fill-rule="evenodd"/>
                  <path d="M55.5,12,31,45H80Z" fill="#c5cfd6" fill-rule="evenodd"/>
                </g>
              ...
              <g transform="translate(347 262)">
                ...
                <g transform="translate(0 152)">
                  <path
                    ...
                    transform="matrix(0.574, -0.819, 0.819, 0.574, 4.598, 142.033)" fill="#b28b67" fill-rule="evenodd"/>
                  <path
                    d="M167.879-7.871c-15.458,12.606-9.49,123.24-10.521,124.632q-.688.928-73.526,15.746l2.1,8.564q85.212-4.167,90.174-10.492,7.1-9.056,17.5-101.336Z"
                  ...
                  <path
                    ...
                    transform="matrix(0.574, -0.819, 0.819, 0.574, 9.439, 143.65)" fill="#2f3676" fill-rule="evenodd"/>
                  ...
                  <path d="M105.256,0l-41.9,100.419-41.178,84.9H31.9L138.188,0Z" fill="#b28b67" fill-rule="evenodd"/>
