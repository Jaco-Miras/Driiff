      ...
      {workspace.topics && Object.keys(workspace.topics).length > 0 ? (
        <li>
          ...
          <ul className="list-group list-group-flush">
            {Object.values(workspace.topics).map((topic) => {
              return <WorkspaceChatList show={true} key={topic.id} workspace={topic} />;
            })}
          </ul>
        </li>
      ) : (
        ...
        >
          ...
          <Timestamp className="text-right ml-auto">
            <WorkspaceChatDateIcons className={"chat-date-icons"} workspace={workspace} optionsVisible={optionsVisible} />
            <WorkspaceChannelOptions selectedWorkspace={workspace} workspace={workspace} onShowOptions={toggleOptions} />
          </Timestamp>
        </Wrapper>
      )}
    </>
