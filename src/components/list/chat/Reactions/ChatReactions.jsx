        ...
        <ChatReactionsContainer isAuthor={isAuthor}>
                ...
                groupedReactions.slice(0, 7).map(r => {
                    return (
                        <EmojiReaction
                            ...
                            key={r.type}
                            type={r.type}
                            count={r.reactions.length}
                            reactions={r.reactions}
                            isAuthor={isAuthor}
                            chatReactionAction={chatReactionAction}
                            reply={reply}
                        />
                    );
                })
            }
            {
                ...
                <MoreEmojis>
                    ...
                    {
                        showMoreEmojis &&
                        <StyledMoreEmojiLists
                            isAuthor={isAuthor}
                            reactions={groupedReactions.slice(7)}
                            className={"chat-reactions-list"}
                            handleShowMoreEmojis={handleShowMoreEmojis}
                            chatReactionAction={chatReactionAction}
                            reply={reply}
                        />
                    }
