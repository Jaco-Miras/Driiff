...
const ChatContentPanel = (props) => {
  ...
  return (
    <Wrapper className={`chat-content ${className}`} onDragOver={handleshowDropZone}>
      ...
      {selectedChannel !== null ? <ChatMessagesVirtuoso selectedChannel={selectedChannel} chatMessageActions={chatMessageActions} timeFormat={timeFormat} dictionary={dictionary} unreadCount={unreadCount} /> : <ChatMessagesPlaceholder />}
