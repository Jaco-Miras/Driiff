      ...
      <div className="d-flex align-items-center p-l-r-0 m-b-20">
        <div className="d-flex justify-content-between align-items-center text-muted w-100">
          <div className="d-inline-flex align-items-start">
            <Avatar className="author-avatar mr-2 post-author" id={post.author.id} name={post.author.name} imageLink={post.author.profile_image_link} sharedUser={workspace && workspace.sharedSlug ? post.author : null} />
            <div>
