...
const WorspaceHeaderPanel = (props) => {
  ...
  const isCreator = activeTopic && activeTopic.slug && activeTopic.sharedSlug && sharedWs[activeTopic.slug] && activeTopic.members.some((m) => m.is_creator && m.external_id === user.id) && isSameDriff;
