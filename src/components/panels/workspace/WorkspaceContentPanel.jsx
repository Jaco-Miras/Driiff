          ...
          <>
            {Object.keys(workspaces).length >= 1 ? (
              <>
                ...
                />
                <Switch>
                  <Route render={(props) => <WorkspaceSearchPanel isExternal={isExternal} {...props}/>}
                         path={["/workspace/search"]}/>
                  <Route
                    render={() => <WorkspaceDashboardPanel {...props} workspace={workspace} isMember={isMember}
                                                           actions={actions} workspaceTimeline={timeline}/>}
                  ...
                  />
                  <Route render={() => <WorkspacePeoplePanel {...props} workspace={workspace} isMember={isMember}/>}
                  ...
                  <Route {...props} component={WorkspaceSettingsPanel}
                         path={["/workspace/settings/:folderId/:folderName/:workspaceId/:workspaceName", "/workspace/settings/:workspaceId/:workspaceName", "/workspace/settings"]}/>
                  <Redirect
                    from="*"
                    to={{
                      pathname: "/workspace",
