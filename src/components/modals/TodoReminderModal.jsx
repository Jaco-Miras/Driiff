...
const TodoReminderModal = (props) => {
  ...
  let dictionary = {
    ...
    remindMeOn: _t("REMINDER.REMIND_ME_ON", "Remind me"),
    message: _t("REMINDER.MESSAGE", "Message"),
    oneHour: _t("REMINDER.ONE_HOUR", "in 1 hour"),
    threeHours: _t("REMINDER.THREE_HOURS", "in 3 hours"),
    tomorrow: _t("REMINDER.TOMORROW", "tomorrow"),
    pickDateTime: _t("REMINDER.PICK_DATE_TIME", "at a specific time"),
