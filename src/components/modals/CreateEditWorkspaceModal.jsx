...
const CreateEditWorkspaceModal = (props) => {
  ...
  return (
    <Modal isOpen={modal} toggle={toggle} centered size={"md"} onOpened={onOpened}>
      <ModalHeaderSection toggle={toggle}>{mode === "edit" ? "Edit " + activeTabName + " workspace" : "Create new " + activeTabName + " workspace"}</ModalHeaderSection>
      <ModalBody onDragOver={handleShowDropzone}>
        ...
        <WrapperDiv>
          ...
          <SelectPeople valid={valid.team} options={userOptions} value={form.selectedUsers} onChange={handleSelectUser} />
